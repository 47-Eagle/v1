...
/**
 * @title ConfigureRegistrySonic
 * @notice Configure EagleRegistry on Sonic with all chains
 * @dev Note: Sonic uses a DIFFERENT LayerZero V2 endpoint than other chains!
 */
contract ConfigureRegistrySonic is Script {
    ...
    address constant LZ_SONIC = 0x6F475642a6e85809B1c36Fa62763669b1b48DD5B; // DIFFERENT!
    ...
    function run() external {
        console.log("CONFIGURE: EagleRegistry on Sonic");
        uint256 pk = vm.envUint("PRIVATE_KEY");
        require(block.chainid == 146, "Must run on Sonic");
        ...
        console.log("Note: Sonic uses unique LZ endpoint:", LZ_SONIC);
    }
    ...
    function _setEndpoints(EagleRegistry registry) internal {
        ...
        registry.setLayerZeroEndpoint(146, LZ_SONIC); // Different endpoint!
